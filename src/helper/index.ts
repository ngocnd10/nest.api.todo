 ...
 * @param keys
 */
export function except(obj: Record<string, any>, keys: Array<string>): Record<string, any> {
  const _obj = {};
 ...
 * Group by
 */
export function groupBy(arr: Array<Record<string, any>>, key: string): Record<string, any> {
  const obj = {};
  arr.forEach(o => {
    obj[o[key]] = o;
  });
